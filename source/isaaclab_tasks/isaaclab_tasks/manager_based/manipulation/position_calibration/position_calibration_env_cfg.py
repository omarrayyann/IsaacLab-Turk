...
import isaaclab_tasks.manager_based.manipulation.position_calibration.mdp as mdp
...
@configclass
class PositionCalibrationSceneCfg(InteractiveSceneCfg):
    ...
    # add room from https://omniverse-content-production.s3-us-west-2.amazonaws.com/Assets/Isaac/4.5/Isaac/Environments/Simple_Room/simple_room.usd
...
@configclass
class PositionCalibrationEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the position calibration end-effector pose tracking environment."""

    # Scene settings
    scene: PositionCalibrationSceneCfg = PositionCalibrationSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings

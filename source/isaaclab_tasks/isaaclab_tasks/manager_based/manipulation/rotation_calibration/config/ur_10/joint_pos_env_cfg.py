...
from isaaclab_tasks.manager_based.manipulation.rotation_calibration.rotation_calibration_env_cfg import RotationCalibrationEnvCfg
...
@configclass
class UR10RotationCalibrationEnvCfg(RotationCalibrationEnvCfg):
...
@configclass
class UR10RotationCalibrationEnvCfg_PLAY(UR10RotationCalibrationEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
